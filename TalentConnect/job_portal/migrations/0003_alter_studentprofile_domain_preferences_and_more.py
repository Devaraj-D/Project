# Generated by Django 4.2.16 on 2024-12-06 06:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('job_portal', '0002_domain_skill_studentprofile_cv_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Choose preferred domains', to='job_portal.domain'),
        ),
        migrations.AlterField(
            model_name='studentprofile',
            name='skills',
            field=models.ManyToManyField(blank=True, help_text='Select applicable skills', to='job_portal.skill'),
        ),
